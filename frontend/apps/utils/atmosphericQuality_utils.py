...
metrics = {
    "L3_SO2": {"min": 0.0, "max": 0.0005, "band": "SO2_column_number_density"},
    "L3_CO": {"min": 0.0, "max": 0.05, "band": "CO_column_number_density"},
    "L3_NO2": {"min": 0.0, "max": 0.0002, "band": "NO2_column_number_density"},
    "L3_HCHO": {"min": 0.0, "max": 0.0003, "band": "tropospheric_HCHO_column_number_density"},
    "L3_AER_AI": {"min": -1, "max": 2.0, "band": "absorbing_aerosol_index"},
    "L3_O3": {"min": 0.12, "max": 0.15, "band": "O3_column_number_density"}
}
...
def mapVisualization(eegeom,start_year,start_month,end_year,end_month,frequency='Weekly',metric='L3_NO2'):
    ...
    m = leafmap.foliumap.Map(location=location, zoom_start=12,attr=attr,tiles=tiles)
