...
import ee
import geemap
import leafmap.foliumap as folMap
import folium
import os
import json
import calendar
...
folMap.Map.add_ee_layer = add_ee_layer
    ...
    with row1_col2:
        ...
        if submitted:
            ...
            if data:
                ...
                #m = folMap.Map(location=location, zoom_start=12,tiles='Esri Satellite')
                m = general_utils.getEsriMap(location=location)
